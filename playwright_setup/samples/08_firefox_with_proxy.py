#!/usr/bin/env python3
"""
サンプル8: Firefoxでプロキシを使ったアクセス

proxy.py を使ってJWT認証プロキシ経由でFirefoxからアクセスします。
...
def main():
    ...
    try:
        with sync_playwright() as p:
            ...
            # スクリーンショット
            print("\n4. スクリーンショットを保存...")
            page.screenshot(path="example_firefox_with_proxy.png")
            print("   ✅ 保存完了: example_firefox_with_proxy.png")
